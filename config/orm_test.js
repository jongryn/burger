...
// Import the connection file directly, in order to terminate the connecdtion at the end of the test run
...
orm.selectAll('burgers', function (data) {
    ...
    console.log('______________Burger Menu__________\n');

    for (var i = 0; i < data.length; i++) {
        console.log('Burger ID = ' + data[i].id);
        console.log('Burger Name = ' + data[i].burger_name);
        console.log('Available = ' _data[i].devoured);
